    ...
    <div class="span12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <a class='btn show-tooltip' style='margin-bottom:10px !important;' title='Create' href='<?php echo url()."/quizquestion/create"; ?>' ><i class='icon-plus'> Create</i></a>
                @if (count($QuizQuestionList) > 0 && !is_null($QuizQuestionList))
                <table class="table table-advance" id="table_quiz_question">
                    ...
                    @foreach ($QuizQuestionList as $item)
                        ...
                        <tr>
                            <td>
                                <a class='btn btn-small btn-danger show-tooltip btnDelete' id="btnDelete" title='Delete' href='<?php echo url()."/quizquestion/delete/".$item->getId(); ?>'><i class='icon-trash'></i></a>
                ...
                @endif
                <a class='btn show-tooltip' style='margin-top:10px !important;' title='Create' href='<?php echo url()."/quizquestion/create"; ?>'><i class='icon-plus'> Create</i></a>
            </div>
        </div>
    </div>
</div>
